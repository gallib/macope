...
use Gallib\Macope\App\TypeCategory;
use Gallib\Macope\App\Http\Requests\TypeCategoryRequest;
...
class TypeCategoryController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('macope::type-categories.index', compact(['typeCategories']));
    }
    ...
    {
        return view('macope::type-categories.create');
    }

    /**
     * Store a newly created resource in storage.
     *
     * @param  \Gallib\Macope\App\Http\Requests\TypeCategoryRequest  $request
     * @return \Illuminate\Http\Response
     */
    ...
    public function show($id)
    {
        ...
        return view('macope::type-categories.show', compact(['typeCategory']));
    }
    ...
    public function edit($id)
    {
        ...
        return view('macope::type-categories.edit', compact(['typeCategory']));
    }
